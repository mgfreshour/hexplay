 ...
 * @class Array2d
 */
class Array2d extends events.EventEmitter {
     ...
     */
    constructor (height?: number, width?: number, value?: any) {
        super();
        value = value || 0;
        if (height && width) {
     ...
     */
    public generate (height?: number, width?: number, value?: any, cloneFn?: Function): void {
     ...
     */
    public setMulti (coords: Array<IPoint>, value: any): void {
        let n: number;
     ...
     */
    public set (x: number, y: number, value: any, cloneFn?: Function): void {
     ...
     * @returns {Array<any>}
     */
    public getInternalData (): Array<any> {
        return this.data;
    }
